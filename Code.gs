...
const PGD_COLS = ['id', 'kode', 'namaPerangkat', 'instansi', 'kategori', 'merk', 'jumlah', 'satuan',
  'hargaSatuan', 'total', 'vendor', 'noPO', 'divisi', 'tglAjukan', 'tglButuh', 'status', 'catatan',
...
const PGD_INPUT = ['namaPerangkat', 'instansi', 'kategori', 'merk', 'jumlah', 'satuan', 'hargaSatuan', 'total',
  'vendor', 'noPO', 'divisi', 'tglAjukan', 'tglButuh', 'status', 'catatan'];
...
const PGD_TEXT = ['id', 'kode', 'noPO', 'tglAjukan', 'tglButuh', 'createdAt', 'updatedAt'];
